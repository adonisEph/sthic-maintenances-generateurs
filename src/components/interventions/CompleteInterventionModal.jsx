        ...
        <div className="p-4 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <div className="flex flex-col">
              <label className="text-xs text-gray-500 mb-1">Nombre d'heure dernière vidange</label>
            ...
            <div className="flex flex-col">
              <label className="text-xs text-gray-500 mb-1">Date dernière vidange</label>
              <div className="border border-gray-200 bg-gray-50 rounded-lg px-3 py-2 text-sm font-semibold text-gray-800">
            ...
            <div className="flex flex-col">
              <label className="text-xs text-gray-500 mb-1">Régime de fonctionnement du generateur</label>
              <div className="border border-gray-200 bg-gray-50 rounded-lg px-3 py-2 text-sm font-semibold text-gray-800">
