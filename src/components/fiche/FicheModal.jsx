...
const FicheModal = ({
  ...
  const coolantRule = useMemo(() => {
    ...
    const epv1Status = epv1Rec ? (epv1Rec.warehouseCoolant5lOk === true ? true : epv1Rec.warehouseCoolant5lOk === false ? false : null) : null;
    const epv2Status = epv2Rec ? (epv2Rec.warehouseCoolant5lOk === true ? true : epv2Rec.warehouseCoolant5lOk === false ? false : null) : null;

    const anyProvidedTrue = recs.some((f) => f && f.warehouseCoolant5lOk === true);
