  ...
  try {
    ...
    for (const it of interventions) {
      ...
      const insertRes = await env.DB.prepare(
        'INSERT OR IGNORE INTO interventions (id, site_id, planned_date, epv_type, technician_user_id, technician_name, status, created_by_user_id, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)'
      )
